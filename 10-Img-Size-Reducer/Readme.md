...
- 🎯 Specify target size in KB (e.g., 100 KB)
- 📉 Automatic compression and resizing logic
- 📥 Instant download of the compressed image
- 🔄 Images are deleted automatically after download
...
4. Click "Compress"
5. Wait for the result and download the optimized image
